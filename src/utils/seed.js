  ...
  try {
    ...
    for (const agency of createdAgencies) {
      ...
      const manager = new User({
        firstName: 'Manager',
        lastName: cityName,
        email: `manager.${cityName.toLowerCase()}@autoclean.fr`,
        password: commonPassword,
        phone: `0622222222`,
    ...
    const prestationsData = [
      {
        name: 'Lavage Extérieur Classique',
        description: 'Nettoyage carrosserie.',
        price: 15,
        durationMinutes: 20,
      },
      {
        name: 'Lavage Intérieur',
        description: 'Aspiration complète.',
        price: 25,
        durationMinutes: 30,
      },
      {
        name: 'Lavage Premium Intégral',
    ...
    const optionsData = [
      {
        ...
        description: 'Aspiration approfondie.',
        price: 15,
        durationMinutes: 20,
      },
    ...
    dateFuture1.setDate(dateFuture1.getDate() + 2);
    const dateFuture2 = new Date();
    dateFuture2.setDate(dateFuture2.getDate() + 5);
    ...
    const bookingsData = [
      ...
      },
      {
        ...
        options: [createdOptions[0]._id, createdOptions[2]._id],
        date: dateFuture2,
        totalPrice: 90,
    ...
    vacStart.setDate(vacStart.getDate() + 10);
    const vacEnd = new Date();
    vacEnd.setDate(vacEnd.getDate() + 15);

    const sickStart = new Date();
    sickStart.setDate(sickStart.getDate() + 1);
    const sickEnd = new Date();
    sickEnd.setDate(sickEnd.getDate() + 2);

    const absencesData = [
      {
        employee: emp1Paris._id,
        agency: emp1Paris.agency,
        startDate: vacStart,
        endDate: vacEnd,
        reason: 'Vacation',
        status: 'Approved', // Déjà validé par le Manager
      },
      {
        employee: emp2Paris._id,
        agency: emp2Paris.agency,
        startDate: sickStart,
        endDate: sickEnd,
        reason: 'Sick',
