...
} = require('../validations/prestationValidation');
...
router.post(
  ...
  validate(createPrestationSchema),
  prestationController.create
);
router.put(
  '/:id',
  verifyToken,
  restrictTo('SuperAdmin'),
  validate(updatePrestationSchema),
  prestationController.update
);
